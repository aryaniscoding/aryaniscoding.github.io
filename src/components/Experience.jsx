  ...
  const experiences = [
    {
      ...
      logo: '/images/companies/shoption.jpg', // Add your logo here
      url: 'https://shoption.in',
      color: '#2563eb',
    },
    {
      company: 'Aeronica Advance Technologies Pvt. Ltd.',
      ...
      logo: '/images/companies/aeronica.jpg', // Add your logo here
      url: 'https://aeronica.in',
      color: '#3b82f6',
    },
    {
      company: 'NxTechWorks Consulting Pvt. Ltd.',
      ...
      logo: '/images/companies/nxtechworks.jpg', // Add your logo here
      url: 'https://nxtechworks.com',
      color: '#1e40af',
    },
  ]
